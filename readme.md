...
scGMB（single-cell GCN-Mamba）将图卷积网络（GCN）与 Mamba 状态空间模型相结合，用于单细胞 RNA 测序的细胞类型分类。流程为：先通过 GCN 在细胞-基因图上聚合邻居信息，再由 Mamba 对表达特征进行序列建模，最后输出细胞类型预测。
...
| 数据集 | 来源 | 细胞数 | 类别数 |
|--------|------|--------|--------|
| Zheng 68K | 人 PBMC | ~68,000 | 11 |
| Zheng sorted | 人 PBMC 子集 | ~20,000 | 11 |
| Baron Human | 人胰腺 | 8,569 | 13 |
| Baron Mouse | 小鼠胰腺 | 1,886 | 13 |
| AMB | 小鼠脑 | 2,715 | 22 |
